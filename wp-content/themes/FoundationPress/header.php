...
<html class="no-js" <?php language_attributes(); ?> >
	...
	<div class="gradient" style="width: 100%; height: 50px; background: #4AA1D6;background: -webkit-linear-gradient(-90deg, #4AA1D6, #B9D247);background: -o-linear-gradient(-90deg, #4AA1D6,  #B9D247);background: -moz-linear-gradient(-90deg, #4AA1D6,  #B9D247);background: linear-gradient(-90deg, #4AA1D6,  #B9D247);"></div>
