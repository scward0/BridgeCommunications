...
<html class="no-js" <?php language_attributes(); ?> >
	...
	<div class="gradient" style="position: fixed;z-index:100;top: 0;width: 100%; height: 20px; background: #4AA1D6;background: -webkit-linear-gradient(-90deg, #B9D247, #4AA1D);background: -o-linear-gradient(-90deg, #B9D247, #4AA1D6);background: -moz-linear-gradient(-90deg, #B9D247, #4AA1D6);background: linear-gradient(-90deg, #B9D247, #4AA1D6);"></div>
