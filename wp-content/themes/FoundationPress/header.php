		...
		<nav id="site-navigation" class="main-navigation" role="navigation" style="float: right;">
			<div class="top-bar-left">
				<ul id="#menu" class="menu" style="text-transform: uppercase; font-size: 14px;">
					<li><a style="color: black;" href="#mission-purpose" rel="home">Mission &amp; Purpose</a></li>
					<li><a style="color: black;" href="#app-contents" rel="home">App Contents</a></li>
					<li><a style="color: black;" href="#features-services" rel="home">Features &amp; Services</a></li>
					<li><a style="color: black;" href="#testimonials" rel="home">Testimonials</a></li>
					<li><a style="color: black;" href="#stay-connected" rel="home">Newsletter Sign-Up</a></li>
