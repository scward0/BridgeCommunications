...
<html class="no-js" <?php language_attributes(); ?> >
		...
		<nav id="site-navigation" class="main-navigation show-for-large" role="navigation" style="float: right">
			<div class="top-bar-left">
				<ul id="#menu" class="menu" style="text-transform: uppercase; font-size: 14px; font-weight: 600;">
					<li><a class="text-center" id="top-nav-mission" href="http://bioprismbridge.com/#mission-purpose" rel="home">Mission &amp; Purpose</a></li>
					<li><a class="text-center" id="top-nav-features" href="http://bioprismbridge.com/#features-services" rel="home">Features &amp; Services</a></li>
					<li><a class="text-center" id="top-nav-app" href="http://bioprismbridge.com/#app-contents" rel="home">App Contents</a></li>
					<li><a class="text-center" id="top-nav-testimonials" href="http://bioprismbridge.com/#testimonials" rel="home">Testimonials</a></li>
					<li><a class="text-center" id="top-nav-stay" href="http://bioprismbridge.com/#stay-connected" rel="home">Newsletter Sign-Up</a></li>
	...
	<div class="mobile-nav hide animated">
		<ul class="vertical menu">
			<li><a class="text-center"  class="mobile-anchor" href="http://bioprismbridge.com/#mission-purpose/" rel="home">Mission &amp; Purpose</a></li>
			<li><a class="text-center"  class="mobile-anchor"href="http://bioprismbridge.com/#features-services" rel="home">Features &amp; Services</a></li>
			<li><a class="text-center"	class="mobile-anchor"href="http://bioprismbridge.com/#app-contents" rel="home">App Contents</a></li>
			<li><a class="text-center"  class="mobile-anchor"href="http://bioprismbridge.com/#testimonials" rel="home">Testimonials</a></li>
			<li><a class="text-center" 	class="mobile-anchor"href="http://bioprismbridge.com/#stay-connected" rel="home">Newsletter Sign-Up</a></li>
